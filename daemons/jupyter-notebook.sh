...
# ATTRIBUTION: https://gist.github.com/shawnrice/11076762

daemonName="jupyter_notebook"

pidDir="/var/pids/jupyter_notebook"
...
doCommands() {
  ...
  sudo -u vagrant jupyter notebook /notebooks
}
